...
int main(int argc, char *argv[])
{
    ...
    //    sprintf_s(out_file, "%s%s%s_out.wav", drive, dir, fname);
    //    simpleDenoise(in_file, out_file);
    //}

	char *in_file = "D:\\Files\\Learning Materials\\Y3\\Semester-2\\CPT202\\VR\\reduce\\Project1\\Project1\\sample.wav";
	char *out_file = "D:\\Files\\Learning Materials\\Y3\\Semester-2\\CPT202\\VR\\reduce\\Project1\\Project1\\s.wav";
	simpleDenoise(in_file, out_file);
